...
public enum ErrorCode {
    ...
    REQUEST_NOT_EDITABLE(HttpStatus.CONFLICT, "REQUESTED 상태의 요청글만 수정할 수 있습니다."),
    ...
    REQUEST_VERSION_CONFLICT(HttpStatus.CONFLICT, "요청글이 다른 사용자에 의해 변경되었습니다. 최신 정보를 확인한 뒤 다시 시도해주세요."),
